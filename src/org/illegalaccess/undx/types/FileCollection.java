...
public class FileCollection extends Hashtable<String, OdexFileDetails> {
	...
	private static Logger jlog = Logger
			.getLogger("org.illegalaccess.undx.FileCollection");

	public void buildthedeps() {
		for (Enumeration<String> e = keys(); e.hasMoreElements();) {
			OdexFileDetails ofd = get(e.nextElement());
			jlog.info(ofd.file);
			ClassCollection cc = ofd.theclasses;

			DexClassDetails jlObject = cc.get("Ljava/lang/Object;");
